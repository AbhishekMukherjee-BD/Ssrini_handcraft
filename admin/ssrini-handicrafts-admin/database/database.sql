...
-- Initial seeds
INSERT IGNORE INTO admins (id, name, email, password, role) VALUES (1, 'Admin', 'admin@ssrini.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin');

INSERT IGNORE INTO categories (id, name, slug) VALUES 
(1, 'Rings', 'rings'),
(2, 'Sculptures', 'sculptures'),
(3, 'Textiles', 'textiles'),
(4, 'Earrings', 'earrings'),
(5, 'Vessels', 'vessels'),
(6, 'Decor', 'decor');

INSERT IGNORE INTO store_settings (id, store_name, currency) VALUES (1, 'Ssrini Handicrafts', 'INR');
